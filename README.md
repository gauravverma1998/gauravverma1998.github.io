...
Detail-oriented .NET Developer with **4 years of experience** specializing in C# and WPF. Proven ability to design, develop, and maintain robust software applications using the .NET framework — creating efficient, scalable solutions.
...
- `Jan 2024 — Present` — **Software Developer**
- `Jan 2023 — Dec 2023` — **Graduate Software Engineer**
- `Jan 2022 — Dec 2022` — **Trainee Software Engineer**

Optimized application performance and reduced memory usage by ~25–30%. Built scalable WPF components, refactored legacy modules, and resolved high-priority production issues.
...
**Tools:** Visual Studio · Git · Bitbucket · JIRA · Jenkins · Prism · xUnit
...
- **Email** — mayuverm11@gmail.com
- **Phone** — +91 81071 07793
